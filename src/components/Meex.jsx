  ...
  return (
    <>
      <div id="alignLogoBrand">
        {" "}
        <div id="meexLogo"> MEEX </div>
        <h2 className="open" onClick={() => setIsOpen(!isOpen)}>
          Meex
        </h2>{" "}
      </div>
      {isOpen && (
        <div id="meexBody" onClick={() => setIsOpen(!isOpen)}>
          <h1 id="titreCentre"> Meex</h1>
          <span className="close">X</span>
          <h2 className="titreMeex2">Projet et contexte</h2>
          <div id="projet">
            <div className="projet-contexte">
              <p>
                <h4>Sujet: </h4>campagne de collecte de fonds pour associations
                caritatives par le biais d'un ambassadeur célèbre
              </p>
              <p>
                <h4>Durée:</h4>3 jours
              </p>
              <p>
                <h4>Méthodologie: </h4> solo
              </p>

              <p>
                <h4>Objectif:</h4>créer un parcours utilisateur fluide vers
                l'action de don{" "}
              </p>
            </div>
            <div className="projet-contexte">
              <p>
                <h4>Equipe:</h4> projet individuel en amont d'une équipe de 4
                développeurs web
              </p>
              <h4>Les outils utilisés: </h4>travail en solo
              <ul>
                <li>
                  <strong>Tableau blanc et post-it:</strong> phase d'idéation
                </li>

                <li>
                  <strong>Trello et G Drive:</strong> concertation avec équipe
                  développeurs
                </li>
                <li>
              ...
              <p>
                <h4>Ce que j'améliorerais:</h4>UI, design général
              </p>
              <p>
                <h4>Ce que j'ai apprécié:</h4> liberté d'action, temps ++ pour
                la documentation
              </p>
            </div>
          </div>
          <h2 className="titreMeex2">Process Design Sprint</h2>
          <div>
            <h3 className="titreMeex3">JOUR 1: COMPRENDRE/CHALLENGER</h3>
            <h4 className="titreMeex4">Test application mobile</h4>

            <div className="setupColumn">
              <div className="adjust50">
                TEST D'EMPATHIE: nous avons testé le site mobile Jeff de Bruges
                pour déceler les potentielles problématiques rencontrées par
                l'utilisateur. Puis,nous avons regroupé sous forme de "Comment
                pourrions-nous?" (CPN) les remarques qui revenaient le plus
                souvent.
                <p>
                  Ceci nous a orienté vers une approche centrée sur
                  <strong> {""}l'achat en ligne </strong>et{" "}
            ...
            <div>
              ...
              <ul>
                <li>
                  <strong>"conseiller l'achat de chocolat sans goûter?"</strong>
                </li>
                <li>
                  <strong>"personnaliser aux goûts de l'utilisateur?"</strong>
                </li>
                <li>
            ...
            <div className="setupColumn">
              ...
              <div className="adjust50">
                ...
                <strong>un parcours utilisateur </strong>tenant compte du tunnel
            ...
            <div className="setupColumn">
              <div className="adjust50">
                ...
                de croquis détaillé. Nous avons ensuite voté pour le croquis le
                plus adapté aux problématiques définies le JOUR 1. Nous y avons
                ajouté des parties complémentaires issues des autres croquis
                afin de compléter le parcours final.
              </div>
              <img id="croquis" src={croquisJeff} alt="cpn"></img>
            </div>
            <p>
              <i>
                <strong>En tant qu'interviewer,</strong> j'ai mis en place un
                formulaire de recrutement avec une ou deux questions me
                permettant de cibler les cinq testeurs nécessaires à la
                cohérence de nos feedbacks (ensuite publié sur les réseaux
                sociaux).J'ai récupéré les réponses et sélectionné les personnes
                proches de notre persona.
              </i>
            </p>
            ...
            <p>
              <i>
                <strong>En tant qu'interviewer,</strong> j'ai préparé le guide
                d'interview nous permettant d'obtenir les remarques pertinentes
                pour nos problématiques. Les 5 rendez-vous ont été confirmé par
                e-mail, dans lequel j'ai apporté des précisions sur le
                déroulement du test. J'ai rédigé un GoogleDoc/PDF de mode
                d'emploi de l'application ZOOM sur mobile, fourni aux testeurs
                avant le test.{" "}
              </i>
            </p>
            ...
            <div>
              ...
              test dure env. 40 min. L'utilisateur a été invité à commander une
              boîte de chocolat et la faire envoyer à sa grand-mère. Les données
              correspondant au parcours testé lui ont été indiquées au fur et à
              mesure de l'expérience.
            </div>
            <p>
              <i>
                <strong>En tant qu'interviewer,</strong> mon but a été de
                laisser l'utilisateur exprimer son avis et rebondir sur ces
                remarques pour comprendre les points de frictions, pourquoi et
                comment y remédier. En trame de fond, je garde en tête les
                problématiques que sont "pallier à l'impossibilité de goûter",
                "personnaliser en fonction des goûts personnels" et "fluidifier
                le parcours".
              </i>
            </p>
            ...
            <div>
              ...
              <ul>
                <li>
                  <strong>
                    {" "}
                    Une incohérence dans l'indicateur de navigation( ou "fil
                    d'ariane"),avec des étapes répétitives
                  </strong>
                </li>
                <li>
                  <strong>
                    {" "}
                    Un parcours surpenant: l'utilisateur s'attend à voir une
                    proposition de chocolat immédiatement, avant de remplir une
              ...
              <div className="setupColumn">
                <img id="matrice" src={matriceJeff} alt="matrice"></img>
                <div className="adjust50">
          ...
          <div>
            ...
            <p>
              <strong>Le parcours choisi:</strong> vous souhaitez offrir une
              boîte de chocolat à votre grand-mère et lui faire livrer chez elle{" "}
            </p>
          </div>
        </div>
      )}
