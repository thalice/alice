        ...
        <div id="jeffBody" onClick={() => setIsOpen(!isOpen)}>
          ...
          <div id="projet">
            <div className="projet-contexte">
              ...
              <p>
                <h4>Objectif:</h4>guider l'utilisateur souhaitant acheter du
                chocolat en ligne{" "}
              </p>
            </div>
            <div className="projet-contexte">
              ...
              <p>
                <h4>Ce que j'améliorerais:</h4>fluidité du parcours
              </p>
              <p>
                <h4>Ce que j'ai apprécié:</h4> équipe dynamique et
                investie,projet gourmand, challenge d'un produit peu aisé à
                vendre en ligne
              </p>
            </div>
          </div>
